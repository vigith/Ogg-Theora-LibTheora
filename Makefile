# This Makefile is for the Ogg::Theora::LibTheora extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Ogg/Theora/LibTheora.pm]
...
MAKE = make
FULLEXT = Ogg/Theora/LibTheora
BASEEXT = LibTheora
PARENT_NAME = Ogg::Theora
DLBASE = $(BASEEXT)
...
XS_FILES = LibTheora.xs
C_FILES  = LibTheora.c
O_FILES  = LibTheora.o
H_FILES  = ppport.h
MAN1PODS = 
MAN3PODS = lib/Ogg/Theora/LibTheora.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Ogg/Theora
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Ogg/Theora
...
TO_INST_PM = lib/Ogg/Theora/LibTheora.pm

PM_TO_BLIB = lib/Ogg/Theora/LibTheora.pm \
	blib/lib/Ogg/Theora/LibTheora.pm
...
DISTNAME = Ogg-Theora-LibTheora
DISTVNAME = Ogg-Theora-LibTheora-0.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Ogg/Theora/LibTheora.pm $(INST_MAN3DIR)/Ogg::Theora::LibTheora.$(MAN3EXT) 
...
clean :: clean_subdirs
	- $(RM_F) \
	  ...
	  *$(OBJ_EXT) pm_to_blib \
	  LibTheora.c $(INST_ARCHAUTODIR)/extralibs.ld \
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '    Ogg::LibOgg:  0' >> META_new.yml
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Ogg/Theora/LibTheora.pm blib/lib/Ogg/Theora/LibTheora.pm 
